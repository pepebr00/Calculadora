# A função eval do Python permite executar expressões contidas em strings. 
# É útil quando o código a ser executado só é conhecido no momento da execução.

# O __slots__ avisa o Python para não usar um dicionário e apenas alocar espaço 
# para um conjunto fixo de atributos. Programadores viram uma redução de quase 
# 40 a 50% no uso de RAM usando essa técnica.
